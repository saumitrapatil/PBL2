...
if __name__ == "__main__":
    ...
    dataset = LowLightDataset(
        low_light_dir="../data/lol_dataset/our485/low", 
        normal_dir="../data/lol_dataset/our485/high"
    )
    ...
    for epoch in range(10):
        ...
        torch.save(diffusion_model.state_dict(), f"../checkpoints/diffusion_model_epoch_{epoch+1}.pth")
        torch.save(generator.state_dict(), f"../checkpoints/generator_epoch_{epoch+1}.pth")

        #Save latest model checkpoint
        torch.save(diffusion_model.state_dict(), "../checkpoints/diffusion_model_latest.pth")
